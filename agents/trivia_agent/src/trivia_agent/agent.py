...
def get_agent_card(host: str, port: int):
    ...
    skill = AgentSkill(
        ...
        examples=["Give me a trivia question", "Quiz me on science", "Let's play trivia about history"],
    )
    return AgentCard(
        name="Trivia Master",
        description=dedent(
...
class TriviaExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue):
        ...
        await task_updater.update_status(
            ...
            new_text_message(
                "Coming up with a trivia question...", context_id=task_updater.context_id, task_id=task_updater.task_id
            ),
        )
        ...
        try:
            ...
            await task_updater.update_status(
                ...
                new_text_message(reply, context_id=task_updater.context_id, task_id=task_updater.task_id),
            )
...
def run():
    ...
    request_handler = DefaultRequestHandler(
        agent_executor=TriviaExecutor(), task_store=InMemoryTaskStore(), agent_card=agent_card
    )
